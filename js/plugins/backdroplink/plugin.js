...
(function ($, Backdrop, CKEDITOR) {
    ...
    init: function (editor) {
      ...
      editor.addCommand('backdroplink', {
        ...
        exec: function (editor) {
          ...
          // loads the JavaScript file instead of Backdrop. Pull translated
          // strings from the plugin settings that are translated server-side.
          var dialogSettings = {
            title: linkElement ? editor.config.backdropLink_dialogTitleEdit : editor.config.backdropLink_dialogTitleAdd,
   ...
   *
   * Backdrop CKEditor build doesn't include the 'link' plugin. Because it
   * includes its own link plugin that integrates with Backdrop's dialog system.
